    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="relative bg-gradient-to-b from-white to-blue-50 py-20 md:py-32">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Planeje sua viagem perfeita, sempre
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 mb-8">
                Crie roteiros, organize destinos e compartilhe seus planos de
          ...
          {/* Fundo Decorativo Recortado na Parte Inferior */}
          <div
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                ...
                <p className="text-gray-600">
                  Visualize sua viagem com mapas interativos. Veja todo o seu
                  roteiro de relance.
                </p>
              </div>
              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                ...
                <p className="text-gray-600">
                  Organize sua viagem dia a dia. Nunca perca nada com
              ...
              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  Planejamento Arrastar e Soltar
                </h3>
                <p className="text-gray-600">
                  Reorganize facilmente seu roteiro com funcionalidade simples
        ...
        <section className="py-16 md:py-24 bg-gray-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-blue-50 mb-8 max-w-2xl mx-auto">
              Junte-se a milhares de viajantes que planejam viagens melhores com
              o TripPlanner.
            </p>
            <AuthButton
              isLoggedIn={isLoggedIn}
            ...
            >
              {isLoggedIn ? 'Confira' : 'Cadastre-se Agora'}
            </AuthButton>
          </div>
        </section>
      </main>
